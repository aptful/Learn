...
public final class FavshopscreenBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FavshopscreenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FavshopscreenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.favshopscreen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FavshopscreenBinding bind(@NonNull View rootView) {
