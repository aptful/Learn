...
class keywordEditScreen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val addButton11 : ImageButton = findViewById(R.id.addButton11)
        val addedButton11 : ImageButton = findViewById(R.id.addedButton11)
        ...
        //追加ボタン11の動き
        addButton11.setOnClickListener{
            addButton11.visibility = View.INVISIBLE
            addedButton11.visibility = View.VISIBLE
            count++
        }
        //追加済ボタン11の動き
        addedButton11.setOnClickListener{
            addedButton11.visibility = View.INVISIBLE
            addButton11.visibility = View.VISIBLE
            count--
        }
